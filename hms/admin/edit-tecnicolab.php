...
if (isset($_POST['submit'])) {
    ...
    $sql               = mysqli_query($con, "Update tecnico_lab set tecnicoName='$tecnicoName',address='$labaddress',labFees='$labfees',contactno='$contactno',labEmail='$labemail' where id='$did'");
    if ($sql) {
