...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO rayosx (tipo, nombre, codigo, costo) 
                                 VALUES ('$tipo', '$nombre', '$codigo', '$costo')");
    
    if ($query) {
        $_SESSION['msg'] = "Rayos X agregado exitosamente !!";
    } else {
        $_SESSION['msg'] = "Error al agregar Rayos X";
    }
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <title>Admin | Exámenes de rayos X</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Exámenes de Rayos X</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Admin</span>
                            ...
                            <div class="col-md-12">
                                <div class="row margin-top-30">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">Agregar Examen de Rayos X</h5>
                                            </div>
                                            <div class="panel-body">
                                                ...
                                                <form role="form" name="dcotorspcl" method="post">
                                                    <div class="form-group">
                                                        <label for="Tipo">Tipo de Rayos X</label>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">Administrar Exámenes de Rayos X</h5>
                                            </div>
                                            <div class="panel-body">
                                                <table class="table table-hover" id="sample-table-1">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = mysqli_query($con, "SELECT * FROM rayosx");
                                                        $cnt = 1;
