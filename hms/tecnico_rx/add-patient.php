...
if (isset($_POST['submit'])) {
    ...
    if ($sql_user) {
        ...
        $sql_patient = mysqli_query($con, "INSERT INTO tblpatient (user_id, tecrxid, PatientAdmision, PatientName, FechaNac, PatientContno, PatientEmail, PatientGender, PatientAdd, PatientAge, PatientMedhis) VALUES ('$user_id', '$tecrxid', '$patadmi', '$patname', '$fena', '$patcontact', '$patemail', '$gender', '$pataddress', '$patage', '$medhis')");
        if ($sql_patient) {
...
<html lang="es">
<head>
    <title>Rayos X | Agregar paciente</title>
