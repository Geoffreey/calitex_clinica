...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "UPDATE doctors SET 
        ...
        WHERE docEmail='" . $_SESSION['dlogin'] . "'");

    if ($sql) {
        echo "<script>alert('✅ Información del médico actualizada con éxito');</script>";
    }
}
?>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Médico | Editar detalles del doctor</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li><span>Médico</span></li>
                                <li class="active"><span>Editar detalles del doctor</span></li>
                            </ol>
                        </div>
                    </section>
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <p><b>Registro de perfil: </b><?php echo htmlentities($data['creationDate']); ?></p>
                                                <?php if ($data['updationDate']) { ?>
                                                    <p><b>Última actualización del perfil: </b><?php echo htmlentities($data['updationDate']); ?></p>
                                                <?php } ?>
                                                <hr />
