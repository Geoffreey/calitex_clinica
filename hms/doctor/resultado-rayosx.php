        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-10">
                            <h1 class="mainTitle">Paciente | Resultados Rayos X</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Paciente</span>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-hover" id="sample-table-1">
                                ...
                                <tbody>
                                    ...
                                    $sql = mysqli_query($con, "SELECT l.nombre AS rxname, l.tipo AS rxtype, l.costo, a.appointmentDate, a.id AS appointment_id
                                    ...
                                    while ($row = mysqli_fetch_array($sql)) {
                                        ...
                                        $file_sql = mysqli_query($con, "SELECT FilePath FROM tblfiles WHERE appointmentrx_id = '".$row['appointment_id']."' LIMIT 1");
