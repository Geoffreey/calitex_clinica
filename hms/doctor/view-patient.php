                                             ...
                                             <div class="modal-body">
                                                <table class="table table-bordered table-hover data-tables">
                                                   <form method="post" name="submit">
                                                      ...
                                                      <tr>
                                                         <th>Examen fisico:</th>
                                                         <td><textarea name="exf" placeholder="examnen fisico" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
                                                      </tr>
                                                      <tr>
                                                         <th>Preescripsion:</th>
                                                         <td><textarea name="pres" placeholder="Medical Prescription" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
                                                      </tr>
                                                      <tr>
                                                         <th>Ordenes medicas:</th>
                                                         <td><textarea name="ord" placeholder="Ordenes medicas" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
                                                      </tr>
                                                      <tr>
                                                         <th>Evolucion:</th>
                                                         <td><textarea name="evo" placeholder="Evolucion" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
                                                      </tr>
                                                      <tr>
                                                         <th>Laboratorio:</th>
                                                         <td><textarea name="lab" placeholder="laboratorio" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
                                                      </tr>
                                                      <tr>
                                                         <th>Rayos x:</th>
                                                         <td><textarea name="rayx" placeholder="rayos x" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
                                                      </tr>
                                                   </table>
                                                </div>
